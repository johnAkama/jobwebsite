        ...
        <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center">
            <div>
                ...
                <p className="text-white pb-[13px] opacity-70 leading-7">
                    ...
                    Dicta fugit non, corporis sequi odio nam ut officiis
                    reiciendis.
                </p>
            </div>
            <div className="grid">
            ...
            <div className="grid">
                ...
                <div>
                    <p className='text-white text-[12px] mb-[10px]'>johnakama32@gmail.com</p>
                    <span className='p-[8px] bg-white rounded-full m-[8px]'>📞</span>
                    <span className='p-[8px] bg-white rounded-full m-[8px]'>📲</span>
                    <span className='p-[8px] bg-white rounded-full m-[8px]'>☎</span>
                </div>
            </div>
